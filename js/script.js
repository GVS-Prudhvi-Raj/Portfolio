        ...
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                ...
                navLinks.forEach(link => {
                    ...
                    if (link.textContent === navName) { link.classList.add('active'); }
                });
            }
        });
    }, { root: mainElement, rootMargin: '-50% 0px -50% 0px' });
